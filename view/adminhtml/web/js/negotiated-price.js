            ...
            if (fieldValue) {
                switch ($input.attr('data-key')) {
                    case 'percentage':
                        ...
                        $(this.options.inputs.proposedGrandTotal).val(this.options.catalogPriceValue - amountDiscount.toFixed(2));
                        break;

                    case 'amount':
                        percentageDiscount = this.getPercentageValue(fieldValue, this.options.catalogPriceValue).toFixed(2);
                    ...
                    case 'proposed':
                        ...
                        percentageDiscount = this.getPercentageValue(amountDiscount, this.options.catalogPriceValue).toFixed(2);
